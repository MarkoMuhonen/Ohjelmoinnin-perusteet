...
menus: Menus = {
    "päävalikko": {
        "1": ("Aseta käyttäjä", act_set_user),
        "2": ("Lisää kohde", act_add_item),
        "3": ("Listaa kohteet", act_list_items),
        "4": ("Tyhjennä kohteet", act_clear_items),
        "s": ("Siirry asetuksiin", act_go_settings),
        "t": ("Siirry tiedostoon", act_go_file),
        "q": ("Lopeta", act_quit),
    },
    "asetukset": {
